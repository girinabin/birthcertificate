                                        ...
                                        <div class="card card-success">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="dobInEnglish" id="dobInEnglish" class="form-control " value="{{ $applicationForm->dobInEnglish }}" autocomplete="off" placeholder="">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="fatherNameInNepali">Father Name<i class="text-danger">*</i></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="motherNameInNepali">Mother Name<i class="text-danger">*</i></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="provinceInNepali">{{ __('Province') }}<i class="text-danger">*</i></label>
                                                    <select class="form-control select2 input-lg dynamic" name="provinceInNepali" id="" style="width: 100%;" data-dependent="districtInNepali">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="districtInNepali">{{ __('District') }}<i class="text-danger">*</i></label>
                                                    <select class="form-control select2 input-lg dynamic" name="districtInNepali" id="districtInNepali" style="width: 100%;" data-dependent="municipalityInNepali">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="municipalityInNepali">{{ __('Gaupalika / Municipality') }}<i class="text-danger">*</i></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="wardNumberInNepali">{{ __('Ward Number') }}<i class="text-danger">*</i></label>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <label for="villageInNepali">{{ __('Village / Tole') }}<i class="text-danger">*</i></label>
